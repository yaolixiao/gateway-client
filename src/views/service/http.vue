    ...
    <el-row>
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          <span v-if="isEdit === false">添加http服务</span>
        ...
        <div style="margin-bottom: 50px">
          <el-form ref="form" :model="form" label-width="140px">
            ...
            <el-form-item label="支持https">
              ...
              <span style="color: #606266; font-weight: 700; margin: 0 20px 0">
                支持strip_uri</span
              >
              <el-switch
            ...
            <el-form-item label="Header转换">
              <el-input
                ...
                placeholder="Header转换支持 add(增加)/del(删除)/eidt(修改) 格式：add headername headervalue"
              ></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    handleSubmit() {
      ...
      // Object.assign({}, this.form) 加上{}表示浅拷贝
    ...
    fetchData(id) {
      ...
      serviceDetail(query)
        .then((response) => {
          ...
          this.form.weight_list = response.data.load_balance.weight_list;
